...
#ifndef SPBE_MACH_REGISTER_H_
#define SPBE_MACH_REGISTER_H_
...
public:
    ...
    MachRegister(uint32_t reg) : m_reg(reg) {}
    ...
    bool operator == (const MachRegister& other) const {
